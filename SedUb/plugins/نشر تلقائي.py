...
async def _(event):
    ...
    if jok.startswith("@"):
        ...
        HuRe = jok.replace("https://t.me/", "@")
    elif str(jok).startswith("-100"):
        HuRe = str(jok).replace("-100", "")
    else:
        try:
            HuRe = int(jok)
