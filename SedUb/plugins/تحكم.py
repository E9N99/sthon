...
ZelzalDV_cmd = (
    "[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗧𝗛𝗢𝗡 - اوامــر المطـور المســاعد](t.me/veevvw) .\n\n"
...
@l313l.ar_cmd(
    pattern="صف المطور (تفعيل|تعطيل)$",
    command=("صف المطور", plugin_category),
    info={
        "header": "لـ تفعيـل/تعطيـل صف المطــور وفتـح/قفـل التحكـم لـ المطــور",
        "الاستـخـدام": "{tr}صف المطور تفعيل / تعطيل",
    },
)
